...
import getAccountByBPNumber from '@salesforce/apex/AS_RandomVisitController.getAccountByBPNumber';
import createRandomPaymentWorkOrder from '@salesforce/apex/AS_RandomVisitController.createRandomPaymentWorkOrder';
...
export default class AsRandomPayment extends NavigationMixin(LightningElement) {
