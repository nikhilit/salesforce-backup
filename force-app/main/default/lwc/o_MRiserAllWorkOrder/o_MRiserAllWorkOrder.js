...
const LIST_VIEW_API_NAME = 'O_MAllWorkOrder';

const GET_ALL_WORKORDERS = gql`
query getAllWorkOrders($userId: ID!) {
  uiapi {
    query {
      WorkOrder(
         where: {
...
export default class O_MRiserAllWorkOrder extends NavigationMixin(LightningElement) {
    @track workOrders = [];
    ...
    @wire(graphql, { query: GET_ALL_WORKORDERS, variables: '$graphQLVariables' })
