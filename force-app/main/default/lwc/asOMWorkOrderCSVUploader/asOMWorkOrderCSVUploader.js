...
import getObjectList from '@salesforce/apex/OMWorkOrderCSVUploaderContr.getObjectList';
import uploadCSVBatch from '@salesforce/apex/OMWorkOrderCSVUploaderContr.uploadCSVBatch';
import uploadLargeCSVChunk from '@salesforce/apex/OMWorkOrderCSVUploaderContr.uploadLargeCSVChunk';


export default class AsOMWorkOrderCSVUploader extends NavigationMixin(LightningElement) {
