...
//import getItemDescriptionOptions from '@salesforce/apex/RiserDetailsForRiserPaintingDayWiseContr.getItemDescriptionOptions';
//import getItemCodeOptions from '@salesforce/apex/RiserDetailsForRiserPaintingDayWiseContr.getItemCodeOptions';
import updateWOLItemRiserPainting from '@salesforce/apex/RiserDetailsForRiserPaintingDayWiseContr.updateWOLItemRiserPainting';
import materialConsumption from '@salesforce/apex/RiserDetailsForRiserPaintingDayWiseContr.materialConsumption';
...
//import getNumberOfRisersWO from '@salesforce/apex/RiserDetailsForRiserPaintingDayWiseContr.getNumberOfRisersWO';
//import getWorkOrderLineItem from '@salesforce/apex/RiserDetailsForRiserPaintingDayWiseContr.getWorkOrderLineItem';
import checkRiserPaintingPossible from '@salesforce/apex/RiserDetailsForRiserPaintingDayWiseContr.checkRiserPaintingPossible';

import savePaintingNotPossible from '@salesforce/apex/RiserDetailsForRiserPaintingDayWiseContr.savePaintingNotPossible';
...
export default class RiserDetailsForRiserPaintingDayWiseComp extends LightningElement {
...
get availabilityOptions() {
    ...
    connectedCallback() {
      ...
      //  this.getNumberOfRisersWO(); 
        ...
        this.checkRiserPaintingPossible();

    }

    checkRiserPaintingPossible(){

        checkRiserPaintingPossible({workOrderLineItemId : this.workOrderLineItemId})
        .then(result => {

            console.log('Result ::', result);

             if(result.Is_Riser_Painting_Possible__c !='Yes' && result.Is_Riser_Painting_Possible__c !='No'){
            ...
            if(result.Is_Riser_Painting_Possible__c =='Yes'){

                this.customerAvilable=true;
                this.showCustomerAvailability=false;
            }
              if(result.Is_Riser_Painting_Possible__c =='No'){

                this.customerAvilable=false;
                this.showCustomerAvailability=true;
                this.customerNotAvailableDetails=true;
                this.checkRiserPaintingPossible=true;
                this.customerAvailability= result.Is_Riser_Painting_Possible__c;
                this.paintingNotPossibleValue= result.Riser_Painting_Not_Possible_Remark__c;
            }
...
//                 this.handleBack();
 ...
 const fieldName = event.target.name;
  ...
  let value;
            ...
            this.showHeightOfRiser=true;
            this.mainRiserSelected=true;
        }
         if(field=='Riser Category' && value!='Main Riser'){

            this.showHeightOfRiser=false;
            this.mainRiserSelected=false;
        }
