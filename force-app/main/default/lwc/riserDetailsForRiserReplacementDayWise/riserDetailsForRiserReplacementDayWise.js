...
import getItemDescriptionOptions from '@salesforce/apex/RiserDetailsForRiserReplacementDayWise.getItemDescriptionOptions';
import getItemCodeOptions from '@salesforce/apex/RiserDetailsForRiserReplacementDayWise.getItemCodeOptions';
import updateWOLItemRiserReplacement from '@salesforce/apex/RiserDetailsForRiserReplacementDayWise.updateWOLItemRiserReplacement';
import materialConsumption from '@salesforce/apex/RiserDetailsForRiserReplacementDayWise.materialConsumption';
...
export default class RiserDetailsForRiserReplacementDayWise extends LightningElement {
...
/* commented number of leakages 1 to 10 
 ...
 riserPaintingOptions = [
        ...
        { label: 'No', value: 'No' }
         ...
         @track showCrimpGuarInstallments=false;
 ...
 handleCheckBoxChange(event){
         ...
         if(label=='Riser Painting' && value==true){
          ...
          //  this.showLeakLocationsFields=false;
            ...
            if(label=='Crimp Guard Installments' && value==true){

                this.crimpGuardReplacement=value;
            this.showCrimpsReplacedQuantity=true;
            }
             if(label=='Crimp Guard Installments' && value==false){
  ...
  const fieldName = event.target.name;
    ...
    console.log('field::', field);
     ...
     if(field=='Riser Category' && value=='Main Riser'){
            ...
            this.showCrimpGuarInstallments=true;
          //  this.mainRiserSelected=true;
        }
         if(field=='Riser Category' && value!='Main Riser'){

            this.showCrimpGuarInstallments=false;
           this.showCrimpsReplacedQuantity=false;
           this.crimpGuardReplacement=false;
           this.riserReplacement.numberofCrimpGuardstobeReplaced='';
