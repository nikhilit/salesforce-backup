...
export default class O_MIPDDMCCompleteWorkOrder extends NavigationMixin(LightningElement) {
    ...
    handleRedirectToList() {
        ...
        if (this.selectedStatus === 'Completed') {
            filterName = 'ipdDMCCompletedWorkorder'; // Create this list view in Salesforce
        }
