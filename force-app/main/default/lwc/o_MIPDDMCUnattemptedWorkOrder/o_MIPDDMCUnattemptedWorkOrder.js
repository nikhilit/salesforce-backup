...
export default class O_MIPDDMCUnattemptedWorkOrder extends NavigationMixin(LightningElement) {
    @api selectedStatus;
    ...
    handleRedirectToList() {
        ...
        if (this.selectedStatus === 'Unattempted') {
            filterName = 'ipdDMCUnattemptedWorkorder'; // Create this list view in Salesforce
        }
