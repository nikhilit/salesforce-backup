...
//import getWorkOrderLineItems from '@salesforce/apex/WorkOrderLItemRiserReplacementContr.getWorkOrderLineItems';
...
export default class WorkOrderlItemRiserReplacementOffline extends NavigationMixin(LightningElement) {
   ...
   // openModal=false;
    ...
    handleOpenModal(event){
     ...
     console.log('workOrderLineItemName::',event.currentTarget.dataset.name);
          console.log('workOrderLineItemId::',event.currentTarget.dataset.id);
