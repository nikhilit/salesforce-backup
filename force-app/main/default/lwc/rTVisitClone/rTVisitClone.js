...
export default class RTVisitClone extends NavigationMixin(LightningElement) {
    @api recordId;
    @track account; 
    ...
    chevronClassCheque = 'slds-accordion__section slds-is-open';
    ...
    // getPreviousThreeMonthsRange() {
    //     const today = new Date();

    //     // Start date: first day of 3 months ago
    //     const start = new Date(today.getFullYear(), today.getMonth() - 3, 1);

    //     // End date: first day of the current month
    ...
    applyTransform() {
        ...
        const NEAR_ONE = 0.99; // threshold for “almost original size”
