...
export default class DataTableColumnSelector extends LightningElement {
    ...
    set selectedOption(value) {
        this._selectedOption = Array.isArray(value) ? value : [];
        if (this._options.length > 0) {  
            this.init();   // 🔥 reinitialize when selectedOption arrives
        }
    }
    get selectedOption() {
    ...
    init(){
        ...
        if (Array.isArray(this.selectedOption) && this.selectedOption.length > 0) {
