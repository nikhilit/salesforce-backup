...
import getObjectList from '@salesforce/apex/AS_CSVUploaderController.getObjectList';
import uploadCSVBatch from '@salesforce/apex/AS_CSVUploaderController.uploadCSVBatch';
import uploadLargeCSVChunk from '@salesforce/apex/AS_CSVUploaderController.uploadLargeCSVChunk';
 
export default class AsCsvUploader extends NavigationMixin(LightningElement) {
