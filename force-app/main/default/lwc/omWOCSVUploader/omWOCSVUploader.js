...
import getObjectList from '@salesforce/apex/OMWOCSVUploaderContr.getObjectList';
import uploadCSVBatch from '@salesforce/apex/OMWOCSVUploaderContr.uploadCSVBatch';
import uploadLargeCSVChunk from '@salesforce/apex/OMWOCSVUploaderContr.uploadLargeCSVChunk';
 
export default class OmWOCSVUploader extends NavigationMixin(LightningElement) {
