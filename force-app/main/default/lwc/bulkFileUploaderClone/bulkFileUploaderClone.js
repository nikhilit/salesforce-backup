...
import uploadFileToServer from '@salesforce/apex/AS_BulkFileUploadHandlerClone.uploadFileToServer';
import pollJobProgress from '@salesforce/apex/AS_BulkJobMonitorClone.pollJobProgress';
import { NavigationMixin } from 'lightning/navigation';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';

export default class BulkFileUploaderClone extends NavigationMixin(
    LightningElement
) {
    ...
    handleUploadFinished(event) {
        ...
        uploadFileToServer({ contentDocumentId })
            .then(result => {
                this.state = {
                    ...this.state,
